...
default_year_index = year_options.index(today.year) if today.year in year_options else 0
default_month_index = month_options.index(today.month)

col1, col2 = st.columns(2)
with col1:
    selected_year = st.selectbox("년도", options=year_options, index=default_year_index)
with col2:
    selected_month = st.selectbox("월", options=month_options, index=default_month_index)
