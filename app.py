...
from attendance_generator import generate_attendance_book
...
if uploaded_file:
    ...
    with st.spinner("출석부 생성 중..."):
        output_path = generate_attendance_book(
            source_path=tmp_input_path,
    ...
    st.download_button("출석부 다운로드", data=output_bytes, file_name=filename, mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")